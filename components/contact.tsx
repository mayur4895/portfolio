...
import { PuffLoader } from "react-spinners";
  ...
  const formSchema = z.object({
    ...
    async  function onSubmit(values: z.infer<typeof formSchema>) {
       ...
       try {
        setisloding(true);
        await axios.post("/api/MessageSend", values).then(()=>{
          toast({
            variant:"sucess",
            title: "Message Sent.",
            description: "your message recived successfuly to mayur",
          })
         form.reset();    
          ...
          toast({
            ...
            description: "server error or you aleady message sent",
          })
        }).finally(()=>{
          setisloding(false);
        })
              ...
              <div className="w-full">
                 <h3 className="text-xl">Contact Info</h3>
                  ...
                  <div className="flex flex-col gap-5 mt-8">
                    <div className="p-5 border shadow-md flex gap-4 items-center">
